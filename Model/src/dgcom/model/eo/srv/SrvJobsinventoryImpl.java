...
// ---    Sat Feb 18 15:35:33 PKT 2017
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvJobsinventoryImpl extends DigicomEntityImpl {
    /**
    ...
    public static final int JINVID = AttributesEnum.JinvId.index();
    public static final int LOCATIONID = AttributesEnum.Locationid.index();
    public static final int STOREID = AttributesEnum.Storeid.index();
    public static final int JINVDATE = AttributesEnum.JinvDate.index();
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvJobsinventory");
    }


    /**
     * Gets the attribute value for JinvId, using the alias name JinvId.
     * @return the value of JinvId
     */
    public String getJinvId() {
        return (String) getAttributeInternal(JINVID);
    }

    /**
     * Sets <code>value</code> as the attribute value for JinvId.
     * @param value value to set the JinvId
     */
    public void setJinvId(String value) {
        setAttributeInternal(JINVID, value);
    }
    ...
    /**
     * Gets the attribute value for JinvDate, using the alias name JinvDate.
     * @return the value of JinvDate
     */
    public Date getJinvDate() {
        return (Date) getAttributeInternal(JINVDATE);
    }

    /**
     * Sets <code>value</code> as the attribute value for JinvDate.
     * @param value value to set the JinvDate
     */
    public void setJinvDate(Date value) {
        setAttributeInternal(JINVDATE, value);
    }
    ...
    /**
     * @param jinvId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String jinvId) {
        return new Key(new Object[] { jinvId });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
            ...
            ViewObject        vo=am.findViewObject("myJobsINVPK");
            if (vo!=null)
                {
                   vo.remove();     
                }
            vo=am.createViewObjectFromQueryStmt("myJobsINVPK",
                                                "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getJinvDate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(JinvId,-5)))+1,1) ,5,'0') as PK \n"+
                                                "from srv_jobsinventory \n"+
                                                "Where to_char(JinvDate,'rrmm') ='"+ DigicomClass.doGetFormattedDate(getJinvDate().toString(), "yyMM")+"' \n"+
                                                "and locationid = '"+getLocationid()+"'");
            vo.executeQuery();
            setDoctype(vo.first().getAttribute(0).toString());
        }        
