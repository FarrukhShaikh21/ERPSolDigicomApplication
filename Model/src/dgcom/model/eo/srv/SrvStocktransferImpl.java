...
// ---    Thu Jul 28 07:37:08 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvStocktransferImpl extends DigicomEntityImpl {
    /**
    ...
    /**
     * Sets <code>value</code> as the attribute value for Stransid.
    ...
    /**
     * @param stransid key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String stransid) {
        return new Key(new Object[] { stransid });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvStocktransfer");
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
            ...
            ViewObject        vo=am.findViewObject("mySrvStockTransPK");
            if (vo!=null)
                {
                   vo.remove();     
                }
            vo=am.createViewObjectFromQueryStmt("mySrvStockTransPK",
                                                "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getTdate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(STRANSID,-4)))+1,1) ,4,'0') as PK \n"+
                                                "from srv_stocktransfer \n"+
                                                "Where to_char(Tdate,'rrmm') ='"+ DigicomClass.doGetFormattedDate(getTdate().toString(), "yyMM")+"' \n"+
                                                "and locationid = '"+getLocationid()+"'");
            vo.executeQuery();
            setStransid(vo.first().getAttribute(0).toString());
        }
