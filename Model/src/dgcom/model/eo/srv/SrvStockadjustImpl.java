...
// ---    Fri Aug 19 15:32:19 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvStockadjustImpl extends DigicomEntityImpl {
    /**
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvStockadjust");
    }
     ...
     */
    public static Key createPrimaryKey(String said) {
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
            ...
            ViewObject        vo=am.findViewObject("mySrvStockAdjPK");
            if (vo!=null)
                {
                   vo.remove();     
                }
            vo=am.createViewObjectFromQueryStmt("mySrvStockAdjPK",
                                                "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getSadate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(SAID,-4)))+1,1) ,4,'0') as PK \n"+
                                                "from SRV_STOCKADJUST \n"+
                                                "Where to_char(SADATE,'rrmm') ='"+ DigicomClass.doGetFormattedDate(getSadate().toString(), "yyMM")+"' \n"+
                                                "and locationid = '"+getLocationid()+"'");
            vo.executeQuery();
            setSaid(vo.first().getAttribute(0).toString());
