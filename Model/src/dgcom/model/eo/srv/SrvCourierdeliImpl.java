...
// ---    Thu Jul 14 11:25:11 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvCourierdeliImpl extends DigicomEntityImpl {
    /**
    ...
    public static final int SRVCDDETAIL = AttributesEnum.SrvCddetail.index();
    public static final int SRVDEALERS = AttributesEnum.SrvDealers.index();

    /**
     * This is the default constructor (do not remove).
     */
    public SrvCourierdeliImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvCourierdeli");
    }
    ...
    /**
     * Sets <code>value</code> as the attribute value for Cddate.
     ...
     */
    public RowIterator getSrvCddetail() {
        return (RowIterator) getAttributeInternal(SRVCDDETAIL);
    }
    ...
    /**
     * @param cdid key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String cdid) {
        return new Key(new Object[] { cdid });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        if (operation==DML_INSERT) {
            ...
            ViewObject        vo=am.findViewObject("myCourDelPK");
            if (vo!=null)
                {
                   vo.remove();     
                }
            vo=am.createViewObjectFromQueryStmt("myCourDelPK",
                                                "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getCddate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(CDId,-4)))+1,1) ,4,'0') as PK \n"+
                                                "from SRV_CourierDeli \n"+
                                                "Where to_char(CDDATE,'rrmm') ='"+ DigicomClass.doGetFormattedDate(getCddate().toString(), "yyMM")+"' \n"+
                                                "and locationid = '"+getLocationid()+"'");
            vo.executeQuery();
            setCdid(vo.first().getAttribute(0).toString());
