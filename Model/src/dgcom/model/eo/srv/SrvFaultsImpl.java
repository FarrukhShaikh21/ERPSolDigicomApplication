...
// ---    Mon Sep 26 17:34:52 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvFaultsImpl extends DigicomEntityImpl {
    /**
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvFaults");
    }
    ...
    /**
     * @param faultid key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String faultid) {
        return new Key(new Object[] { faultid });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        ViewObject vo = am.findViewObject("PKFaults");

               if (vo!=null)
               {
               vo.remove();
               }
               vo = am.createViewObjectFromQueryStmt("PKFaults","select LPAD(to_char(nvl(max(Faultid),0)+1),3,'0') as  PKFaults from srv_Faults");
               vo.executeQuery();
               setFaultid(vo.first().getAttribute(0).toString());
           }            
