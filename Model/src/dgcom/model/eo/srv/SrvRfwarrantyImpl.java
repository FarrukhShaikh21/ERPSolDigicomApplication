...
// ---    Thu Feb 23 13:53:20 PKT 2017
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvRfwarrantyImpl extends DigicomEntityImpl {
    /**
    ...
    /**
     * @param rfwid key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(String rfwid) {
        return new Key(new Object[] { rfwid });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dgcom.model.eo.srv.SrvRfwarranty");
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
           ...
           ViewObject        vo=am.findViewObject("mySrvWfwPK");
           if (vo!=null)
               {
                  vo.remove();     
               }
           vo=am.createViewObjectFromQueryStmt("mySrvWfwPK",
                                               "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getRdate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(RFWId,-4)))+1,1) ,4,'0') as PK \n"+
                                               "from SRV_RFWarranty \n"+
                                               "Where to_char(RDate,'rrmm') ='"+ DigicomClass.doGetFormattedDate(getRdate().toString(), "yyMM")+"' \n"+
                                               "and locationid = '"+getLocationid()+"'");
           vo.executeQuery();
           setRfwid(vo.first().getAttribute(0).toString());
       }
