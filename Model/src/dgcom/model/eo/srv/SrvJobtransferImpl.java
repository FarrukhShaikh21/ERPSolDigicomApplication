...
// ---    Sat Jul 02 12:34:58 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvJobtransferImpl extends DigicomEntityImpl {
    /**
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        if (operation==DML_INSERT) {
            ...
            ViewObject        vo=am.findViewObject("myJobTransPK");
            if (vo!=null)
                {
                   vo.remove();     
                }
            vo=am.createViewObjectFromQueryStmt("myJobTransPK",
                                                "Select 2||'"+getLocationid()+"'||'"+DigicomClass.doGetFormattedDate(getTdate().toString(), "yyMM")+"'||Lpad(nvl(max(to_number(substr(transferid,-4)))+1,1) ,4,'0') as PK \n"+
                                                "from srv_jobtransfer \n"+
