...
import dgcom.model.eo.srv.SrvJspartsImpl;
...
// ---------------------------------------------------------------------
public class SrvJspartsVORowImpl extends DigicomViewRowImpl {

    public static final int ENTITY_SRVJSPARTS = 0;
    ...
    public enum AttributesEnum {
        ...
        SrvJobsolutionVO,
        SrvJobqcVO,
        AccSrvJsPartIssueDetPartsConsume;
    ...
    public static final int ACCSRVJSPARTISSUEDETPARTSCONSUME = AttributesEnum.AccSrvJsPartIssueDetPartsConsume.index();

    /**
     * This is the default constructor (do not remove).
     */
    public SrvJspartsVORowImpl() {
    }

    /**
     * Gets SrvJsparts entity object.
     * @return the SrvJsparts
     */
    public SrvJspartsImpl getSrvJsparts() {
        return (SrvJspartsImpl) getEntity(ENTITY_SRVJSPARTS);
    }
    ...
    /**
     * Gets the attribute value for TXT_PART_DESCRIPTION using the alias name txtPartName.
     * @return the TXT_PART_DESCRIPTION
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for TXT_PART_DESCRIPTION using the alias name txtPartName.
     * @param value value to set the TXT_PART_DESCRIPTION
     */
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AccSrvJsPartIssueDetPartsConsume.
     */
    public RowSet getAccSrvJsPartIssueDetPartsConsume() {
        return (RowSet) getAttributeInternal(ACCSRVJSPARTISSUEDETPARTSCONSUME);
    }
