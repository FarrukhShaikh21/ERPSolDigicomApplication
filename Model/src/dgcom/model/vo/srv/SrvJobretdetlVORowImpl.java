...
import dgcom.model.eo.srv.SrvJobretdetlImpl;
...
// ---    Tue Jul 05 10:49:08 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrvJobretdetlVORowImpl extends DigicomViewRowImpl {


    public static final int ENTITY_SRVJOBRETDETL = 0;
    ...
    public enum AttributesEnum {
        ...
        AccSrvJobReturnDetailSrvJobCardPendJobRet;
    ...
    public static final int ACCSRVJOBRETURNDETAILSRVJOBCARDNO =
        AttributesEnum.AccSrvJobReturnDetailSrvJobCardNo.index();
    public static final int ACCSRVJOBRETURNDETAILSRVJOBCARDPENDJOBRET =
        AttributesEnum.AccSrvJobReturnDetailSrvJobCardPendJobRet.index();

    /**
     * This is the default constructor (do not remove).
     */
    public SrvJobretdetlVORowImpl() {
    }

    /**
     * Gets SrvJobretdetl entity object.
     * @return the SrvJobretdetl
     */
    public SrvJobretdetlImpl getSrvJobretdetl() {
        return (SrvJobretdetlImpl) getEntity(ENTITY_SRVJOBRETDETL);
    }
    ...
    /**
     * Gets the associated <code>Row</code> using master-detail link SrvJobreturnVO.
     */
    public Row getSrvJobreturnVO() {
        return (Row) getAttributeInternal(SRVJOBRETURNVO);
    }

    /**
     * Sets the master-detail link SrvJobreturnVO between this object and <code>value</code>.
     */
    public void setSrvJobreturnVO(Row value) {
        setAttributeInternal(SRVJOBRETURNVO, value);
    }

    /**
     * Gets the associated <code>Row</code> using master-detail link SrvJobReturnDetailSrvJobCardNoCIC_0055QVO.
     */
    public Row getSrvJobReturnDetailSrvJobCardNoCIC_0055QVO() {
        return (Row) getAttributeInternal(SRVJOBRETURNDETAILSRVJOBCARDNOCIC_0055QVO);
    }

    /**
     * Sets the master-detail link SrvJobReturnDetailSrvJobCardNoCIC_0055QVO between this object and <code>value</code>.
     */
    public void setSrvJobReturnDetailSrvJobCardNoCIC_0055QVO(Row value) {
        setAttributeInternal(SRVJOBRETURNDETAILSRVJOBCARDNOCIC_0055QVO, value);
    }

    /**
     * Gets the view accessor <code>RowSet</code> AccSrvJobReturnDetailSrvJobCardNo.
     */
    public RowSet getAccSrvJobReturnDetailSrvJobCardNo() {
        return (RowSet) getAttributeInternal(ACCSRVJOBRETURNDETAILSRVJOBCARDNO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> AccSrvJobReturnDetailSrvJobCardPendJobRet.
     */
    public RowSet getAccSrvJobReturnDetailSrvJobCardPendJobRet() {
        return (RowSet) getAttributeInternal(ACCSRVJOBRETURNDETAILSRVJOBCARDPENDJOBRET);
    }

    @Override
    public boolean isAttributeUpdateable(int i) {
        // TODO Implement this method
        if (getSrvJobreturnVO().getAttribute("Posted").equals("Y")) {
            return false;
        }
        else
