...
public class CIC_0012 {
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvInvoiceVOCRUDIterator");
            OperationBinding ob = bc.getOperationBinding("Commit");
            ob.execute();
            ib.getViewObject().getCurrentRow().setAttribute("Posted", "Y");
            ib.getViewObject().getCurrentRow().setAttribute("InvAmnt", getIt3().getValue());
            ...
            ob = bc.getOperationBinding("doSubmitServiceInvoice");
            ob.execute();
    ...
    public String doShowAccounting() {
        // Add event code here...
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\SRV_INVOICE.rep");
        reportBean.setReportParameter("USER",DigicomClass.getConnectedUser());
        reportBean.setReportParameter("FORM","SRV_INVOICE");
        reportBean.setReportParameter("COMP","2");
        reportBean.setReportParameter("SRV_INVNO",getIt1().getValue().toString());
