...
public class CIC_0196 {
    ...
    public List<SelectItem> getSuggestedModel(String resourceName) {
        ...
        DCIteratorBinding ib=bc.findIteratorBinding("SrvRfwarrantyCRUDIterator");
    ...
    public String doNew() {
        ...
        DCIteratorBinding ib=(DCIteratorBinding)bindings.get("SrvRfwarrantyCRUDIterator");
        OperationBinding operationBinding = bindings.getOperationBinding("doCreateNewWarrantyRow");
        Object result = operationBinding.execute();
        operationBinding = bindings.getOperationBinding("doCreateNewWarrantyDetRow");
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            ob = bc.getOperationBinding("doSubmitWarrantyRefresh");
            ob.execute();
