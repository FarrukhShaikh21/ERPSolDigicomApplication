...
public class CIC_0045 {
    ...
    private RichInputListOfValues stnnoId;
    ...
    public void setStnnoId(RichInputListOfValues stnnoId) {
        this.stnnoId = stnnoId;
    }

    public RichInputListOfValues getStnnoId() {
        return stnnoId;
    }
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvStnreceivingCRUDIterator");
            ...
            ob = bc.getOperationBinding("doSubmitStnReceiving");
            ob.execute();
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\STN_Receiving_Print_Doc.rep");
        ...
        reportBean.setReportParameter("RECENO",getIt1().getValue().toString());
