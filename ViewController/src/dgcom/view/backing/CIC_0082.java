...
public class CIC_0082 {
    ...
    private RichInputListOfValues docidId;
    ...
    public void setDocidId(RichInputListOfValues docidId) {
        this.docidId = docidId;
    }

    public RichInputListOfValues getDocidId() {
        return docidId;
    }
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvLogisticCRUDIterator");
            ...
            ob = bc.getOperationBinding("doSubmitJobLogistic");
            ob.execute();
    ...
    public String doNew() {
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("doCreateNewLogisticRow");
        Object result = operationBinding.execute();
        operationBinding = bindings.getOperationBinding("doCreateNewLogisticDetRow");
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\Logistics.rep");
        reportBean.setReportParameter("USER",DigicomClass.getConnectedUser());
        reportBean.setReportParameter("FORM","Srv_Logistic");
        reportBean.setReportParameter("COMP","2");
        reportBean.setReportParameter("logistic_id",getIt1().getValue().toString());
    ...
    public void setOt1(RichInputText ot1) {
        this.ot1 = ot1;
    }

    public RichInputText getOt1() {
        return ot1;
    }
}
