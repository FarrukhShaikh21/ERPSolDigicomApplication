...
public class CIC_0032 {
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvJobtransferCRUDIterator");
            ...
            ob = bc.getOperationBinding("doSubmitJobTransfer");
            ob.execute();
    ...
    public String doNew() {
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("doCreateNewJobTransferRow");
        Object result = operationBinding.execute();
         operationBinding = bindings.getOperationBinding("doCreateNewJobTransDetRow");
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\job_transfer.rep");
        reportBean.setReportParameter("USER",DigicomClass.getConnectedUser());
        reportBean.setReportParameter("FORM","Srv_Job_Transfer");
        reportBean.setReportParameter("COMP","2");
        reportBean.setReportParameter("TRANSFER",getIt1().getValue().toString());
