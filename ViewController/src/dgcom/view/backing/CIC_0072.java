...
public class CIC_0072 {
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvCourierdeliCRUDIterator");
            ...
            ob = bc.getOperationBinding("doSubmitCourDelivery");
            ob.execute();
    ...
    public String doNew() {
        ...
        OperationBinding operationBinding = bindings.getOperationBinding("doCreateNewCourierDelRow");
        Object result = operationBinding.execute();
        operationBinding = bindings.getOperationBinding("doCreateNewCourierDelDetRow");
        ...
        for (int i = 0; i < 9; i++) {
           ...
           operationBinding.getParamsMap().put("Cdid", getIt1().getValue());
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\SRV_COURIERDELI.rep");
        reportBean.setReportParameter("USER",DigicomClass.getConnectedUser());
        reportBean.setReportParameter("FORM","srv_SetDelivery");
        reportBean.setReportParameter("COMP","2");
        reportBean.setReportParameter("V_CDID",getIt1().getValue().toString());
