...
public class CIC_0208 {
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("InItemPartMovementCRUDIterator");
            OperationBinding ob;
            ...
            ob = bc.getOperationBinding("doSubmitItemPartMove");
            ob.execute();
    ...
    public List<SelectItem> getSuggestedPart(String resourceName) {
        List<SelectItem> resourceList=new ArrayList<SelectItem>();
        DCBindingContainer bc=(DCBindingContainer)BindingContext.getCurrent().getCurrentBindingsEntry();
        DCIteratorBinding ib=bc.findIteratorBinding("InIpmDetailDETCRUDIterator");
        //
        ApplicationModule am=ib.getViewObject().getApplicationModule();
        ViewObject  vo=am.findViewObject("ASBInPartsCIC_0208");
        vo.getViewObject().reset();
    ...
    public List<SelectItem> getSuggestedModel(String resourceName) {
        ...
        DCIteratorBinding ib=bc.findIteratorBinding("InIpmDetailDETCRUDIterator");
        ApplicationModule am=ib.getViewObject().getApplicationModule();
        ViewObject  vo=am.findViewObject("ASBInItemsCIC_0208");
        vo.getViewObject().reset();
