...
public class CIC_0018 {
    ...
    private RichInputComboboxListOfValues txtModelId;
    ...
    public void setTxtModelId(RichInputComboboxListOfValues txtModelId) {
        this.txtModelId = txtModelId;
    }

    public RichInputComboboxListOfValues getTxtModelId() {
        return txtModelId;
    }
    ...
    public List<SelectItem> getSuggestedModel(String resourceName) {
        ...
        DCIteratorBinding ib=bc.findIteratorBinding("InPartsCRUDIterator");
        
        ApplicationModule am=ib.getViewObject().getApplicationModule();
        ViewObject  vo=am.findViewObject("ASBInItemsCIC_0018");
