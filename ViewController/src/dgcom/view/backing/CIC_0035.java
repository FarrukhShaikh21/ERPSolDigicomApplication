...
public class CIC_0035 {
    ...
    public void doDialogEventSubmit(DialogEvent de) {
        if (de.getOutcome() == DialogEvent.Outcome.yes) {
            ...
            DCIteratorBinding ib = bc.findIteratorBinding("SrvSetdeliveryCRUDIterator");
            ...
            ob = bc.getOperationBinding("doSubmitSetDelivery");
            ob.execute();
    ...
    public String doPrint() {
        ...
        reportBean.setReportServerParam(OracleReport.RS_PARAM_REPORT,"Z:\\\\SERVICE\\\\reports\\\\set_delivery.rep");
        ...
        reportBean.setReportParameter("SETDELI",getIt1().getValue().toString());
